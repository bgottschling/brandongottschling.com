...
date: "2025-09-12"
summary: "I'm designing a portable 'soul' for AI. In v0.1 I shipped the Essence File (.ess) schema, a local context planner, and a modular offline assistant loop (PTT → Whisper.cpp → llama.cpp → Piper) that can ingest a swappable 'soul chip.'"
status: "Active v0.1"
